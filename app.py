...
if mode == "관리자 모드":
    ...
    if st.session_state.quote_step == 1:
        ...
        # [복구] 배관 다중 선택 기능 (장바구니 방식) + 스마트 검색 적용
        ...
        if st.button("계산하기 (STEP 2)", type="primary"):
            ...
            # [복구] 주배관/가지관 리스트 계산 로직 (분리 및 다중 처리)
            # 주배관 계산
