...
# ==========================================
# [수정] 0. 페이지 설정을 최상단으로 이동 (구동 에러 방지)
# ==========================================
...
# ==========================================
# [수정] 자재 구성 명세서 PDF 생성 함수 (이미지 2배 확대 + 추가자재섹션)
# ==========================================
def create_composition_pdf(set_cart, pipe_cart, quote_items, db_products, db_sets, quote_name):
    ...
    # 0. 추가 자재 계산을 위한 기본 세트/배관 파생 수량 집계
    baseline_counts = {}
    ...
    pdf.set_font(font_name, '', 10)
    # [수정] 행 높이 15 -> 30, 이미지 영역 확대
    row_h = 30
    header_h = 8
    
    pdf.set_fill_color(240, 240, 240)
    pdf.cell(35, header_h, "IMG", border=1, align='C', fill=True) # 폭 35
...
# [이전 코드 삭제됨: st.set_page_config는 이미 맨 위에서 호출됨]
