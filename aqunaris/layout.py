# -*- coding: utf-8 -*-
# [2026-09-11] 옛 루트 aquanaris_layout.py(V66~ · 상표 철자 오류) → aqunaris/layout.py 로 옮김(내용 무변경). 영문 표기 = Aqunaris.
...
# [V66] aqunaris_app.py가 `from aqunaris.layout import *`로 가져갈 이름 — aq_/AQ_/_aq_/_AQ_ 전부(색상헬퍼 제외)
