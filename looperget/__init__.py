...
⚠️ **배포 단위(프로매니저) = `app.py` + `common/` + `looperget/` 폴더.** (🏪 아쿠나리스 = `aqunaris_app.py` + `aqunaris/` + `common/` · 2026-09-11 분리)
...
PKG_VER = 100  # [V108, 2026-09-11] 🏪 아쿠나리스 분리 — aq_print·aq_fit → aqunaris/ · 공용 → common/
